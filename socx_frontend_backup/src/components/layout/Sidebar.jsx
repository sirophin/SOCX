...
const NAV_ITEMS = [
  ...
  { to: '/upload', label: 'Upload Logs', icon: IconUpload },
  { to: '/investigation', label: 'Investigation', icon: IconSearch },
  { to: '/alerts', label: 'Alerts', icon: IconBell },
  { to: '/detection-rules', label: 'Detection Rules', icon: IconShield },
